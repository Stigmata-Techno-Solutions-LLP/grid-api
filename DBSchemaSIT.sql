IF OBJECT_ID('GridManagement_SIT.dbo.client_billing_layerDetails', 'U') IS NOT NULL 
DROP TABLE GridManagement_SIT.dbo.client_billing_layerDetails; 
 
 
IF OBJECT_ID('GridManagement_SIT.dbo.client_billing', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.client_billing;
 
 
 IF OBJECT_ID('GridManagement_SIT.dbo.layer_subcontractors', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.layer_subcontractors; 

IF OBJECT_ID('GridManagement_SIT.dbo.audit_logs', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.audit_logs; 

 IF OBJECT_ID('GridManagement_SIT.dbo.layer_documents', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.layer_documents; 

IF OBJECT_ID('GridManagement_SIT.dbo.subcontractor_users', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.subcontractor_users; 

IF OBJECT_ID('GridManagement_SIT.dbo.subcontractors', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.subcontractors; 
		
 
 IF OBJECT_ID('GridManagement_SIT.dbo.clients', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.clients; 


 
IF OBJECT_ID('GridManagement_SIT.dbo.layer_details', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.layer_details; 

IF OBJECT_ID('GridManagement_SIT.dbo.layers', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.layers; 
 
 
  IF OBJECT_ID('GridManagement_SIT.dbo.grid_geolocations', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.grid_geolocations; 

  IF OBJECT_ID('GridManagement_SIT.dbo.grid_documents', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.grid_documents; 

 

IF OBJECT_ID('GridManagement_SIT.dbo.grids', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.grids; 

 

IF OBJECT_ID('GridManagement_SIT.dbo.roles_applicationforms', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.roles_applicationforms; 
 
IF OBJECT_ID('GridManagement_SIT.dbo.application_forms', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.application_forms; 
 


IF OBJECT_ID('GridManagement_SIT.dbo.roles', 'U') IS NOT NULL 
  DROP TABLE GridManagement_SIT.dbo.roles; 
 


IF OBJECT_ID('GridManagement_SIT.dbo.users', 'U') IS NOT NULL 
DROP TABLE GridManagement_SIT.dbo.users; 
...
CREATE TABLE GridManagement_SIT.dbo.application_forms (
  id int NOT NULL IDENTITY (1,1),
  "name" varchar(30) NOT NULL,
  "description" varchar(300) NULL, 
  "isAdd" bit NULL,
...
CREATE TABLE GridManagement_SIT.dbo.users (
	id int NOT NULL identity(1,1),	
...
CREATE TABLE GridManagement_SIT.dbo.roles_applicationforms (
id int NOT NULL IDENTITY(1,1),
...
CREATE TABLE GridManagement_SIT.dbo.subcontractors(
id int not null identity(1,1),
...
CREATE TABLE GridManagement_SIT.dbo.clients(
id int not null identity(1,1),
...
CREATE TABLE GridManagement_SIT.dbo.layer_subcontractors(
    id int not null identity(1,1),
...
CREATE TABLE GridManagement_SIT.dbo.layer_documents(
    id int not null identity(1,1),
    layerdetails_id int not null,
...
file_type varchar(10) null,
    ...
    CREATE TABLE GridManagement_SIT.dbo.audit_logs(
        id int not null identity(1,1),
    ...
    CREATE TABLE GridManagement_SIT.dbo.client_billing(
        id int not null identity(1,1),
        client_id int null,
    ...
    CREATE TABLE GridManagement_SIT.dbo.client_billing_layerDetails(
        id int not null identity(1,1),
